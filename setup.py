...
setup(name=metadata["__title__"],
      ...
      packages=['quarkc', 'quarkc.parser', 'quarkc.parser.generated', 'quarkc.test'],
      package_data={'': ['*.q', 'lib/*.q', 'quarkc/parser/*.g4']},
      include_package_data=True,
      install_requires=install_requirements,
      entry_points={"console_scripts": ["quark = quarkc.command:call_main",
                                        "quark-ir = quarkc.emit:call_main",
                                        "quark-macro = quarkc.macro:call_main",
                                        "quark-test = quarkc.testrunner:call_main"]},
