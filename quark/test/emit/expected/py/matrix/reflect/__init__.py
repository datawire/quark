...
Class.classes = {}
Class.VOID = Class(u"void")
Class.BOOL = Class(u"bool")
Class.INT = Class(u"int")
Class.LONG = Class(u"long")
Class.STRING = Class(u"String")
class Field(object):
    def _init(self):
        self.type = None
        self.name = None
