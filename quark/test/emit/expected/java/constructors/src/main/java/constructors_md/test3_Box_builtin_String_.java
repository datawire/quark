...
public class test3_Box_builtin_String_ extends reflect.Class implements io.datawire.quark.runtime.QObject {
    public static reflect.Class singleton = new test3_Box_builtin_String_();
