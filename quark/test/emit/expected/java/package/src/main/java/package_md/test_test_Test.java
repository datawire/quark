...
public class test_test_Test extends reflect.Class implements io.datawire.quark.runtime.QObject {
    public static reflect.Class singleton = new test_test_Test();
