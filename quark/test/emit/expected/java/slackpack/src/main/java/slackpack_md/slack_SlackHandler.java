...
public class slack_SlackHandler extends reflect.Class implements io.datawire.quark.runtime.QObject {
    public static reflect.Class singleton = new slack_SlackHandler();
