...
public class slack_event_Message extends reflect.Class implements io.datawire.quark.runtime.QObject {
    ...
    public slack_event_Message() {
        ...
        (this).fields = new java.util.ArrayList(java.util.Arrays.asList(new Object[]{new reflect.Field("String", "type"), new reflect.Field("slack.User", "user"), new reflect.Field("slack.Channel", "channel"), new reflect.Field("String", "timestamp"), new reflect.Field("String", "subtype"), new reflect.Field("bool", "hidden"), new reflect.Field("String", "text"), new reflect.Field("slack.event.Edited", "edited")}));
