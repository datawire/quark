...
/* END_BUILTIN */
    ...
    public static Object _construct(String className, java.util.ArrayList<Object> args) {
        ...
        if ((className)==("Overload") || ((className) != null && (className).equals("Overload"))) {
            return new Overload((String) ((args).get(0)));
        }
        return null;
    }
    ...
    public static void _class(Class cls) {
        ...
        if (((cls).id)==("Overload") || (((cls).id) != null && ((cls).id).equals("Overload"))) {
            (cls).name = "Overload";
            (cls).parameters = new java.util.ArrayList(java.util.Arrays.asList(new Object[]{}));
            return;
        }
    ...
    public static Object _invoke(String className, Object object, String method, java.util.ArrayList<Object> args) {
        ...
        if ((className)==("Overload") || ((className) != null && (className).equals("Overload"))) {
            if ((method)==("__add__") || ((method) != null && (method).equals("__add__"))) {
                Overload tmp_15 = (Overload) (object);
                return (tmp_15).__add__((Overload) ((args).get(0)));
            }
            if ((method)==("__mul__") || ((method) != null && (method).equals("__mul__"))) {
                Overload tmp_16 = (Overload) (object);
                return (tmp_16).__mul__((Overload) ((args).get(0)));
            }
            if ((method)==("test") || ((method) != null && (method).equals("test"))) {
                Overload tmp_17 = (Overload) (object);
                (tmp_17).test();
                return null;
            }
        }
