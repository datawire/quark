    ...
    public static Object _invoke(String className, Object object, String method, java.util.ArrayList<Object> args) {
        ...
        if ((className)==("Overload") || ((className) != null && (className).equals("Overload"))) {
            if ((method)==("__add__") || ((method) != null && (method).equals("__add__"))) {
                Overload tmp_20 = (Overload) (object);
                return (tmp_20).__add__((Overload) ((args).get(0)));
            }
            if ((method)==("__mul__") || ((method) != null && (method).equals("__mul__"))) {
                Overload tmp_21 = (Overload) (object);
                return (tmp_21).__mul__((Overload) ((args).get(0)));
            }
            if ((method)==("test") || ((method) != null && (method).equals("test"))) {
                Overload tmp_22 = (Overload) (object);
                (tmp_22).test();
                return null;
            }
        }
