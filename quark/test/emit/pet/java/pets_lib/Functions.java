...
/* END_BUILTIN */
    ...
    public static Object _construct(String className, java.util.ArrayList<Object> args) {
        ...
        if ((className)==("pets.Cat") || ((className) != null && (className).equals("pets.Cat"))) {
            return new pets.Cat();
        }
        if ((className)==("pets.Dog") || ((className) != null && (className).equals("pets.Dog"))) {
            return new pets.Dog();
        }
        return null;
    }
    ...
    public static void _class(Class cls) {
        ...
        if (((cls).id)==("pets.Cat") || (((cls).id) != null && ((cls).id).equals("pets.Cat"))) {
            (cls).name = "pets.Cat";
            (cls).parameters = new java.util.ArrayList(java.util.Arrays.asList(new Object[]{}));
            return;
        }
        if (((cls).id)==("pets.Dog") || (((cls).id) != null && ((cls).id).equals("pets.Dog"))) {
            (cls).name = "pets.Dog";
            (cls).parameters = new java.util.ArrayList(java.util.Arrays.asList(new Object[]{}));
            return;
        }
    ...
    public static Object _invoke(String className, Object object, String method, java.util.ArrayList<Object> args) {
        ...
        if ((className)==("pets.Cat") || ((className) != null && (className).equals("pets.Cat"))) {
            if ((method)==("greet") || ((method) != null && (method).equals("greet"))) {
                pets.Cat tmp_17 = (pets.Cat) (object);
                (tmp_17).greet();
                return null;
            }
        }
        if ((className)==("pets.Dog") || ((className) != null && (className).equals("pets.Dog"))) {
            if ((method)==("greet") || ((method) != null && (method).equals("greet"))) {
                pets.Dog tmp_18 = (pets.Dog) (object);
                (tmp_18).greet();
                return null;
            }
        }
