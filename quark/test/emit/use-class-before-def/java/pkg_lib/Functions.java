...
/* END_BUILTIN */
    ...
    public static Object _construct(String className, java.util.ArrayList<Object> args) {
        ...
        if ((className)==("pkg.Bar") || ((className) != null && (className).equals("pkg.Bar"))) {
            return new pkg.Bar();
        }
        if ((className)==("pkg.Foo") || ((className) != null && (className).equals("pkg.Foo"))) {
            return new pkg.Foo();
        }
        return null;
    }
    ...
    public static void _class(Class cls) {
        ...
        if (((cls).id)==("pkg.Bar") || (((cls).id) != null && ((cls).id).equals("pkg.Bar"))) {
            (cls).name = "pkg.Bar";
            (cls).parameters = new java.util.ArrayList(java.util.Arrays.asList(new Object[]{}));
            return;
        }
        if (((cls).id)==("pkg.Foo") || (((cls).id) != null && ((cls).id).equals("pkg.Foo"))) {
            (cls).name = "pkg.Foo";
            (cls).parameters = new java.util.ArrayList(java.util.Arrays.asList(new Object[]{}));
            return;
        }
