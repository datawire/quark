...
def _construct(className, args):
    ...
    if ((className) == (u"Map<String,int>")):
        return _Map()

    if ((className) == (u"Map<String,String>")):
        return _Map()
...
def _class(cls):
    ...
    if (((cls).id) == (u"Map<String,int>")):
        (cls).name = u"Map"
        (cls).parameters = _List([Class(u"String"), Class(u"int")])
        return

    if (((cls).id) == (u"Map<String,String>")):
        (cls).name = u"Map"
        (cls).parameters = _List([Class(u"String"), Class(u"String")])
        return
