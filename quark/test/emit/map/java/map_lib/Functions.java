...
/* END_BUILTIN */
    ...
    public static Object _construct(String className, java.util.ArrayList<Object> args) {
        ...
        if ((className)==("Map<String,int>") || ((className) != null && (className).equals("Map<String,int>"))) {
            return new java.util.HashMap<String,Integer>();
        }
        if ((className)==("Map<String,String>") || ((className) != null && (className).equals("Map<String,String>"))) {
    ...
    public static void _class(Class cls) {
        ...
        if (((cls).id)==("Map<String,int>") || (((cls).id) != null && ((cls).id).equals("Map<String,int>"))) {
            (cls).name = "Map";
            (cls).parameters = new java.util.ArrayList(java.util.Arrays.asList(new Object[]{new Class("String"), new Class("int")}));
            return;
        }
        if (((cls).id)==("Map<String,String>") || (((cls).id) != null && ((cls).id).equals("Map<String,String>"))) {
            (cls).name = "Map";
            (cls).parameters = new java.util.ArrayList(java.util.Arrays.asList(new Object[]{new Class("String"), new Class("String")}));
            return;
        }
