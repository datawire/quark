...
def _construct(className, args):
    ...
    if ((className) == (u"BazBar")):
        return BazBar()

    if ((className) == (u"BazFaz<Object>")):
        return BazFaz()
...
def _invoke(className, object, method, args):
    ...
    if ((className) == (u"RazBar")):
        pass
    if ((className) == (u"RazFaz<Object>")):
        pass
    if ((className) == (u"BazBar")):
        if ((method) == (u"m1")):
            tmp_26 = object;
