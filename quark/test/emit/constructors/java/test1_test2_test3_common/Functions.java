package test1_test2_test3_common;
...
/* END_BUILTIN */
    ...
    public static Object _construct(String className, java.util.ArrayList<Object> args) {
        ...
        if ((className)==("test1.Test") || ((className) != null && (className).equals("test1.Test"))) {
            return new test1.Test();
        }
        if ((className)==("test2.Test") || ((className) != null && (className).equals("test2.Test"))) {
            return new test2.Test((String) ((args).get(0)));
        }
        if ((className)==("test3.Box<String>") || ((className) != null && (className).equals("test3.Box<String>"))) {
    ...
    public static void _class(Class cls) {
        ...
        if (((cls).id)==("test1.Test") || (((cls).id) != null && ((cls).id).equals("test1.Test"))) {
            (cls).name = "test1.Test";
            (cls).parameters = new java.util.ArrayList(java.util.Arrays.asList(new Object[]{}));
            return;
        }
        if (((cls).id)==("test2.Test") || (((cls).id) != null && ((cls).id).equals("test2.Test"))) {
            (cls).name = "test2.Test";
            (cls).parameters = new java.util.ArrayList(java.util.Arrays.asList(new Object[]{}));
            return;
        }
        if (((cls).id)==("test3.Box<String>") || (((cls).id) != null && ((cls).id).equals("test3.Box<String>"))) {
            (cls).name = "test3.Box";
            (cls).parameters = new java.util.ArrayList(java.util.Arrays.asList(new Object[]{new Class("String")}));
            return;
        }
    ...
    public static Object _invoke(String className, Object object, String method, java.util.ArrayList<Object> args) {
        ...
        if ((className)==("test3.Box<String>") || ((className) != null && (className).equals("test3.Box<String>"))) {
            if ((method)==("get") || ((method) != null && (method).equals("get"))) {
                test3.Box<String> tmp_17 = (test3.Box<String>) (object);
                return (tmp_17).get();
            }
        }
        return null;
