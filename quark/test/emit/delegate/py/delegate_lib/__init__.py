...
def _invoke(className, object, method, args):
    ...
    if ((className) == (u"Test")):
        if ((method) == (u"bar")):
            tmp_24 = object;
            return (tmp_24).bar((args)[0], (args)[1], (args)[2])

        if ((method) == (u"foo")):
            tmp_25 = object;
            (tmp_25).foo((args)[0], (args)[1], (args)[2]);
            return None

        if ((method) == (u"rpc")):
            tmp_26 = object;
            return (tmp_26).rpc((args)[0], (args)[1], (args)[2])

        if ((method) == (u"hello")):
            tmp_27 = object;
            return (tmp_27).hello((args)[0])
