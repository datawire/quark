...
class Functions < Object
    ...
    def self.toJSON(obj)
        ...
        result = DatawireQuarkRuntime::JSONObject.new
        if ((obj) == (nil))
            result.setNull()
            return result
        end
        ...
        (result).setObjectItem(("$class"), (DatawireQuarkRuntime::JSONObject.new.setString((cls).id)))
...
class Service < Object
    ...
    def rpc(name, message)
        ...
        envelope = DatawireQuarkRuntime::JSONObject.new
        (envelope).setObjectItem(("$method"), (DatawireQuarkRuntime::JSONObject.new.setString(name)))
...
class Server < Object
    ...
    def onHTTPRequest(request, response)
        ...
        result = (QuarkClass.new(DatawireQuarkCore._getClass(self)).getField("impl")).type.invoke(@impl, method, [argument])
...
class Functions < Object
    ...
    def self._fields(className)
        ...
        if ((className) == ("Class"))
            return [Field.new(QuarkClass.new("String"), "id"), Field.new(QuarkClass.new("String"), "name"), Field.new(QuarkClass.new("List<Class>"), "parameters")]
        end
        if ((className) == ("Field"))
            return [Field.new(QuarkClass.new("Class"), "type"), Field.new(QuarkClass.new("String"), "name")]
        end
        if ((className) == ("List<Object>"))
            return []
        end
        ...
        if ((className) == ("ResponseHolder"))
            return [Field.new(QuarkClass.new("HTTPResponse"), "response")]
        end
        if ((className) == ("Client"))
            return [Field.new(QuarkClass.new("Runtime"), "runtime"), Field.new(QuarkClass.new("String"), "url")]
        end
        if ((className) == ("Server<Object>"))
            return [Field.new(QuarkClass.new("Runtime"), "runtime"), Field.new(QuarkClass.new("Object"), "impl")]
        end
        return nil
...
class Functions < Object
    ...
    def self._class(cls)
        ...
        if (((cls).id) == ("List<Object>"))
            (cls).name = "List"
            (cls).parameters = [QuarkClass.new("Object")]
            return
        end
        if (((cls).id) == ("List<Field>"))
            (cls).name = "List"
            (cls).parameters = [QuarkClass.new("Field")]
            return
        end
        if (((cls).id) == ("List<Class>"))
            (cls).name = "List"
            (cls).parameters = [QuarkClass.new("Class")]
            return
        end
        if (((cls).id) == ("List<String>"))
            (cls).name = "List"
            (cls).parameters = [QuarkClass.new("String")]
            return
        end
        if (((cls).id) == ("Map<Object,Object>"))
            (cls).name = "Map"
            (cls).parameters = [QuarkClass.new("Object"), QuarkClass.new("Object")]
            return
        end
        if (((cls).id) == ("Map<String,Object>"))
            (cls).name = "Map"
            (cls).parameters = [QuarkClass.new("String"), QuarkClass.new("Object")]
            return
        end
