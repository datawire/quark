...
/* END_BUILTIN */
    ...
    public static Object _construct(String className, java.util.ArrayList<Object> args) {
        ...
        if ((className)==("test.Test") || ((className) != null && (className).equals("test.Test"))) {
            return new test.Test();
        }
        if ((className)==("test.test.Test") || ((className) != null && (className).equals("test.test.Test"))) {
    ...
    public static java.util.ArrayList<Field> _fields(String className) {
        ...
        if ((className)==("test.test.Test") || ((className) != null && (className).equals("test.test.Test"))) {
            return new java.util.ArrayList(java.util.Arrays.asList(new Object[]{new Field(new Class("int"), "size")}));
        }
    ...
    public static void _class(Class cls) {
        ...
        if (((cls).id)==("test.Test") || (((cls).id) != null && ((cls).id).equals("test.Test"))) {
            (cls).name = "test.Test";
            (cls).parameters = new java.util.ArrayList(java.util.Arrays.asList(new Object[]{}));
            return;
        }
        if (((cls).id)==("test.test.Test") || (((cls).id) != null && ((cls).id).equals("test.test.Test"))) {
    ...
    public static Object _invoke(String className, Object object, String method, java.util.ArrayList<Object> args) {
        ...
        if ((className)==("test.Test") || ((className) != null && (className).equals("test.Test"))) {
            if ((method)==("go") || ((method) != null && (method).equals("go"))) {
                test.Test tmp_17 = (test.Test) (object);
                (tmp_17).go();
                return null;
            }
        }
        if ((className)==("test.test.Test") || ((className) != null && (className).equals("test.test.Test"))) {
            if ((method)==("go") || ((method) != null && (method).equals("go"))) {
                test.test.Test tmp_18 = (test.test.Test) (object);
                (tmp_18).go();
                return null;
            }
        }
