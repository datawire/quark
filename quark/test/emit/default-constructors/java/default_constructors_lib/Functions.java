...
/* END_BUILTIN */
    ...
    public static Object _construct(String className, java.util.ArrayList<Object> args) {
        ...
        if ((className)==("A") || ((className) != null && (className).equals("A"))) {
            return new A((String) ((args).get(0)));
        }
        if ((className)==("B") || ((className) != null && (className).equals("B"))) {
            return new B((String) ((args).get(0)));
        }
        if ((className)==("C") || ((className) != null && (className).equals("C"))) {
            return new C((String) ((args).get(0)));
        }
        if ((className)==("X") || ((className) != null && (className).equals("X"))) {
            return new X();
        }
        if ((className)==("Y") || ((className) != null && (className).equals("Y"))) {
            return new Y((String) ((args).get(0)));
        }
        return null;
    }
    ...
    public static java.util.ArrayList<Field> _fields(String className) {
        ...
        if ((className)==("A") || ((className) != null && (className).equals("A"))) {
            return new java.util.ArrayList(java.util.Arrays.asList(new Object[]{new Field(new Class("String"), "name")}));
        }
        if ((className)==("B") || ((className) != null && (className).equals("B"))) {
            return new java.util.ArrayList(java.util.Arrays.asList(new Object[]{new Field(new Class("String"), "name")}));
        }
    ...
    public static void _class(Class cls) {
        ...
        if (((cls).id)==("A") || (((cls).id) != null && ((cls).id).equals("A"))) {
            (cls).name = "A";
            (cls).parameters = new java.util.ArrayList(java.util.Arrays.asList(new Object[]{}));
            return;
        }
        if (((cls).id)==("B") || (((cls).id) != null && ((cls).id).equals("B"))) {
            (cls).name = "B";
            (cls).parameters = new java.util.ArrayList(java.util.Arrays.asList(new Object[]{}));
            return;
        }
        if (((cls).id)==("C") || (((cls).id) != null && ((cls).id).equals("C"))) {
            (cls).name = "C";
            (cls).parameters = new java.util.ArrayList(java.util.Arrays.asList(new Object[]{}));
            return;
        }
        if (((cls).id)==("X") || (((cls).id) != null && ((cls).id).equals("X"))) {
            (cls).name = "X";
            (cls).parameters = new java.util.ArrayList(java.util.Arrays.asList(new Object[]{}));
            return;
        }
        if (((cls).id)==("Y") || (((cls).id) != null && ((cls).id).equals("Y"))) {
            (cls).name = "Y";
            (cls).parameters = new java.util.ArrayList(java.util.Arrays.asList(new Object[]{}));
            return;
        }
    ...
    public static Object _invoke(String className, Object object, String method, java.util.ArrayList<Object> args) {
        ...
        if ((className)==("A") || ((className) != null && (className).equals("A"))) {}
        if ((className)==("B") || ((className) != null && (className).equals("B"))) {
            if ((method)==("greet") || ((method) != null && (method).equals("greet"))) {
                B tmp_15 = (B) (object);
                (tmp_15).greet();
                return null;
            }
