...
public class slack_Client extends reflect.Class implements io.datawire.quark.runtime.QObject {
    ...
    public slack_Client() {
        ...
        (this).fields = new java.util.ArrayList(java.util.Arrays.asList(new Object[]{new reflect.Field("Runtime", "runtime"), new reflect.Field("String", "token"), new reflect.Field("slack.SlackHandler", "handler"), new reflect.Field("int", "event_id"), new reflect.Field("WebSocket", "socket")}));
