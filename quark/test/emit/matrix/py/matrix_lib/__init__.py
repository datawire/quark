...
def _construct(className, args):
    ...
    if ((className) == (u"List<List<Object>>")):
        return _List()
...
def _fields(className):
    ...
    if ((className) == (u"Matrix<int>")):
        return _List([Field(Class(u"int"), u"width"), Field(Class(u"int"), u"height"), Field(Class(u"List<List<Object>>"), u"columns")])
...
def _class(cls):
    ...
    if (((cls).id) == (u"List<List<Object>>")):
        (cls).name = u"List"
        (cls).parameters = _List([Class(u"List<Object>")])
        return
...
def _invoke(className, object, method, args):
    ...
    if ((className) == (u"Matrix<int>")):
        if ((method) == (u"__get__")):
            tmp_17 = object;
            return (tmp_17).__get__((args)[0], (args)[1])

        if ((method) == (u"__set__")):
            tmp_18 = object;
            (tmp_18).__set__((args)[0], (args)[1], (args)[2]);
            return None
