Appendix C: Interim Example States - Python Server
==================================================
...
:ref:`Return to Part 2 <Part2PythonResponseDefinition>` of the server definition to continue the tutorial.

.. _part2PythonServerFinished:
...
:ref:`Return to Part 3 <part3PythonProcessRequest>` of the server definition to continue the tutorial.
