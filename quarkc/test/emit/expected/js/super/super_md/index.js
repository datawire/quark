...
function super_A_greet_Method() {
    super_A_greet_Method.super_.call(this, "builtin.void", "greet", []);
}
exports.super_A_greet_Method = super_A_greet_Method;
_qrt.util.inherits(super_A_greet_Method, builtin.reflect.Method);
...
_qrt.util.inherits(super_A, builtin.reflect.Class);
...
function super_B_greet_Method() {
    super_B_greet_Method.super_.call(this, "builtin.void", "greet", []);
}
exports.super_B_greet_Method = super_B_greet_Method;
_qrt.util.inherits(super_B_greet_Method, builtin.reflect.Method);
...
_qrt.util.inherits(super_B, builtin.reflect.Class);
