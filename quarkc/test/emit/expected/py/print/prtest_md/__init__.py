...
class prtest_Test_test_Method(builtin.reflect.Method):
    def _init(self):
        builtin.reflect.Method._init(self)

    def __init__(self):
        super(prtest_Test_test_Method, self).__init__(u"builtin.void", u"test", _List([]));
...
class prtest_Test(builtin.reflect.Class):
    def _init(self):
