...
class ServletProxy(object):
    ...
    def _getClass(self):
        return u"quark.spi.ServletProxy"
...
class HTTPServletProxy(ServletProxy):
    ...
    def _getClass(self):
        return u"quark.spi.HTTPServletProxy"
...
class WSServletProxy(ServletProxy):
    ...
    def _getClass(self):
        return u"quark.spi.WSServletProxy"
