...
public class list_Box_quark_int__set_Method extends quark.reflect.Method implements io.datawire.quark.runtime.QObject {
    public list_Box_quark_int__set_Method() {
