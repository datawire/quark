...
public class quark_spi_api_tracing_HTTPHandlerProxy extends quark.reflect.Class implements io.datawire.quark.runtime.QObject {
    ...
    public quark_spi_api_tracing_HTTPHandlerProxy() {
        ...
        (this).fields = new java.util.ArrayList(java.util.Arrays.asList(new Object[]{new quark.reflect.Field("quark.spi_api_tracing.Identificator", "namer"), new quark.reflect.Field("quark.String", "id"), new quark.reflect.Field("quark.Logger", "log"), new quark.reflect.Field("quark.HTTPHandler", "handler_impl"), new quark.reflect.Field("quark.spi_api_tracing.HTTPRequestProxy", "wrapped_request")}));
    ...
    public Object construct(java.util.ArrayList<Object> args) {
        return new quark.spi_api_tracing.HTTPHandlerProxy((io.datawire.quark.runtime.Logger) ((args).get(0)), (quark.spi_api_tracing.HTTPRequestProxy) ((args).get(1)), (quark.HTTPHandler) ((args).get(2)));
    }
