...
public class quark_test_Test extends quark.reflect.Class implements io.datawire.quark.runtime.QObject {
    ...
    public quark_test_Test() {
        ...
        (this).methods = new java.util.ArrayList(java.util.Arrays.asList(new Object[]{new quark_test_Test_current_Method(), new quark_test_Test_start_Method(), new quark_test_Test_stop_Method(), new quark_test_Test_check_Method(), new quark_test_Test_fail_Method(), new quark_test_Test_run_Method()}));
    }
