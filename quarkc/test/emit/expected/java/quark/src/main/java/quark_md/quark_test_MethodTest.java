...
public class quark_test_MethodTest extends quark.reflect.Class implements io.datawire.quark.runtime.QObject {
    ...
    public quark_test_MethodTest() {
        ...
        (this).methods = new java.util.ArrayList(java.util.Arrays.asList(new Object[]{new quark_test_MethodTest_run_Method(), new quark_test_MethodTest_current_Method(), new quark_test_MethodTest_start_Method(), new quark_test_MethodTest_stop_Method(), new quark_test_MethodTest_check_Method(), new quark_test_MethodTest_fail_Method()}));
    }
