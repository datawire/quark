...
public class RuntimeApi implements quark.Runtime, io.datawire.quark.runtime.QObject {
    public static quark.reflect.Class quark_spi_RuntimeApi_ref = quark_md.Root.quark_spi_RuntimeApi_md;
    public RuntimeSpi impl;
    public RuntimeApi(RuntimeSpi impl) {
        (this).impl = impl;
    }
