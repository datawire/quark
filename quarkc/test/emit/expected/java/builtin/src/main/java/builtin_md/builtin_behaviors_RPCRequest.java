...
public class builtin_behaviors_RPCRequest extends builtin.reflect.Class implements io.datawire.quark.runtime.QObject {
    ...
    public builtin_behaviors_RPCRequest() {
        ...
        (this).fields = new java.util.ArrayList(java.util.Arrays.asList(new Object[]{new builtin.reflect.Field("builtin.behaviors.RPC", "rpc"), new builtin.reflect.Field("builtin.concurrent.Future", "retval"), new builtin.reflect.Field("builtin.List<builtin.Object>", "args"), new builtin.reflect.Field("builtin.concurrent.Timeout", "timeout")}));
    ...
    public Object construct(java.util.ArrayList<Object> args) {
        return new builtin.behaviors.RPCRequest((java.util.ArrayList<Object>) ((args).get(0)), (builtin.behaviors.RPC) ((args).get(1)));
    }
