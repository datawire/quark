...
public class builtin_behaviors_RPC extends builtin.reflect.Class implements io.datawire.quark.runtime.QObject {
    ...
    public builtin_behaviors_RPC() {
        ...
        (this).fields = new java.util.ArrayList(java.util.Arrays.asList(new Object[]{new builtin.reflect.Field("builtin.Service", "service"), new builtin.reflect.Field("builtin.reflect.Class", "returned"), new builtin.reflect.Field("builtin.long", "timeout"), new builtin.reflect.Field("builtin.String", "methodName"), new builtin.reflect.Field("builtin.ServiceInstance", "instance")}));
