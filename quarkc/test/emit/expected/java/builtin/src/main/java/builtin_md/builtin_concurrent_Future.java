...
public class builtin_concurrent_Future extends builtin.reflect.Class implements io.datawire.quark.runtime.QObject {
    ...
    public builtin_concurrent_Future() {
        ...
        (this).methods = new java.util.ArrayList(java.util.Arrays.asList(new Object[]{new builtin_concurrent_Future_onFinished_Method(), new builtin_concurrent_Future_finish_Method(), new builtin_concurrent_Future_isFinished_Method(), new builtin_concurrent_Future_getError_Method(), new builtin_concurrent_Future_await_Method(), new builtin_concurrent_Future_getContext_Method()}));
    }
