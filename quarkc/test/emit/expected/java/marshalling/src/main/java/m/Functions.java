...
public class Functions {
    ...
    public static void test_marshalling() {
        ...
        String encoded = (quark.Functions.toJSON(actual, quark.reflect.Class.get(io.datawire.quark.runtime.Builtins._getClass(actual)))).toString();
        do{System.out.println(encoded);System.out.flush();}while(false);
        Outer expected = new Outer();
        quark.Functions.fromJSON(quark.reflect.Class.get(io.datawire.quark.runtime.Builtins._getClass(expected)), expected, io.datawire.quark.runtime.JSONObject.parse(encoded));
