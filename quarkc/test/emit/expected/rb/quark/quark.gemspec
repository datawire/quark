Gem::Specification.new do |spec|
  ...
  # spec.email       = ''
  # spec.license     = ''
  spec.files       = ['lib/quark.rb', 'lib/quark/reflect.rb', 'lib/quark/behaviors.rb', 'lib/quark/concurrent.rb', 'lib/quark/test_.rb', 'lib/quark_md.rb', 'lib/datawire-quark-core.rb']
  # spec.homepage    = ''
