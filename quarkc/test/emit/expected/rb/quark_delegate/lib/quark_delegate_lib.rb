module Quark
require "builtin"
def self.quark_delegate_lib; MODULE_quark_delegate_lib; end
module MODULE_quark_delegate_lib
...
class CLASS_Ping < ::Quark.quark_delegate_lib.Message
...
class CLASS_Pong < ::Quark.quark_delegate_lib.Message
...
class CLASS_Test < ::DatawireQuarkCore::QuarkObject
    ...
    def rpc(name, msg, options)
        ...
        if ((name) == ("hello"))
            return ::Quark.quark_delegate_lib.Pong.new()
        else
            return nil
        end
...
def self.main()
    ...
    t = ::Quark.quark_delegate_lib.Test.new()
    t.foo("one", "two", 3)
    ::DatawireQuarkCore.print(t.hello(::Quark.quark_delegate_lib.Ping.new()).toString())


    nil
end
end # module MODULE_quark_delegate_lib
end # module Quark
