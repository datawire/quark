...
class Functions < Object
    ...
    def self.main()
        ...
        while ((i) < (e)) do
            if (((i) + (1)) < ((e) + (1)))
                vb = d.getByte(i)
                DatawireQuarkCore.print(((((("B[") + ((i).to_s)) + ("]=")) + ((vb).to_s)) + ("   ")) + (Functions.hexb(vb)))
            end
            if (((i) + (2)) < ((e) + (1)))
                vs = d.getShort(i)
                DatawireQuarkCore.print(((((("S[") + ((i).to_s)) + ("]=")) + ((vs).to_s)) + ("   ")) + (Functions.hexs(vs)))
            end
            if (((i) + (4)) < ((e) + (1)))
                vi = d.getInt(i)
                DatawireQuarkCore.print(((((("I[") + ((i).to_s)) + ("]=")) + ((vi).to_s)) + ("   ")) + (Functions.hexi(vi)))
            end
            if (((i) + (8)) < ((e) + (1)))
                vl = d.getLong(i)
                DatawireQuarkCore.print(((((("L[") + ((i).to_s)) + ("]=")) + ()) + ("   ")) + (Functions.hexl(vl)))
            end
            i = (i) + (1)
        end
        f = c.fromBase64("eWF5")
        ...
        DatawireQuarkCore.print(("float ") + (repr(g.getFloat(0)).to_s))
