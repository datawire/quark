module Quark
def self.json_assembling_md; JsonAssemblingMd; end
module JsonAssemblingMd
...
class QuarkListQuarkString < ::Quark.quark.reflect.QuarkClass
    ...
    static singleton: -> { ::Quark.json_assembling_md.quark_List_quark_String_.new() }
