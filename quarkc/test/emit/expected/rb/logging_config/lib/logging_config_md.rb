module Quark
def self.logging_config_md; LoggingConfigMd; end
module LoggingConfigMd
...
class QuarkListQuarkString < ::Quark.quark.reflect.QuarkClass
    ...
    static singleton: -> { ::Quark.logging_config_md.quark_List_quark_String_.new() }
