module Quark
def self.json_coersion_md; JsonCoersionMd; end
module JsonCoersionMd
...
class QuarkListQuarkString < ::Quark.quark.reflect.QuarkClass
    ...
    static singleton: -> { ::Quark.json_coersion_md.quark_List_quark_String_.new() }
