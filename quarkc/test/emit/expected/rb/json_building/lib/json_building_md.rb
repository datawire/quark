module Quark
def self.json_building_md; JsonBuildingMd; end
module JsonBuildingMd
...
class QuarkListQuarkString < ::Quark.quark.reflect.QuarkClass
    ...
    static singleton: -> { ::Quark.json_building_md.quark_List_quark_String_.new() }
