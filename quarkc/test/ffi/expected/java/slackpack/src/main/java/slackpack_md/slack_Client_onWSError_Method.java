...
public class slack_Client_onWSError_Method extends quark.reflect.Method implements io.datawire.quark.runtime.QObject {
    public slack_Client_onWSError_Method() {
        super("quark.void", "onWSError", new java.util.ArrayList(java.util.Arrays.asList(new Object[]{"quark.WebSocket", "quark.WSError"})));
    }
    public Object invoke(Object object, java.util.ArrayList<Object> args) {
        slack.Client obj = (slack.Client) (object);
        (obj).onWSError((quark.WebSocket) ((args).get(0)), (quark.WSError) ((args).get(1)));
        return null;
    }
