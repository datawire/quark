...
public class quark_List_quark_Object_ extends quark.reflect.Class implements io.datawire.quark.runtime.QObject {
    public static quark.reflect.Class singleton = new quark_List_quark_Object_();
    public quark_List_quark_Object_() {
